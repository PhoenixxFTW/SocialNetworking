...
public class HomeController implements Initializable {
	...
	public void marutiAction(ActionEvent e)
	{
		...
		HomePageController.getInstance().createPage(CarsAnchor, "/client/fxml/Maruti.fxml");
	 ...
	 public void chevroletAction(ActionEvent event) {
		 ...
		 HomePageController.getInstance().createPage(CarsAnchor, "/client/fxml/Chevrolet.fxml");
	 ...
	 public void hyundaiAction(ActionEvent event) {
		 ...
		 HomePageController.getInstance().createPage(CarsAnchor, "/client/fxml/Hyundai.fxml");
